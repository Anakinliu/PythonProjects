...
class TestOptions:
    def __init__(self):
        ...
        # data loader related
        self.parser.add_argument('--text_name', type=str, default='../data/rawtext/yaheiB/val/0801.png',
                                 help='path of the text image')
        self.parser.add_argument('--scale', type=float, default=0.0,
                                 help='glyph deformation degree,  0~1 for single scale, -1 for multiple scales in 0~1 with step of scale_step')
        self.parser.add_argument('--scale_step', type=float, default=0.2, help='scale step')
        self.parser.add_argument('--text_type', type=int, default=0,
        ...
        # model related
        self.parser.add_argument('--structure_model', type=str, default='../save/fire-GS-iccv.ckpt',
                                 help='specified the dir of saved structure transfer models')
        self.parser.add_argument('--texture_model', type=str, default='../save/fire-GT-iccv.ckpt',
                                 help='specified the dir of saved texture transfer models')
...
class TrainShapeMatchingOptions:
    def __init__(self):
        ...
        # data loader realted 
        self.parser.add_argument('--style_name', type=str, default='../data/style/fire.png',
                                 help='path of the style image')
        self.parser.add_argument('--load_GS_name', type=str, default='../save/fire-GS.ckpt',
                                 help='path to load the saved G_S model when training G_T')
        self.parser.add_argument('--Sanglejitter', action='store_true', default=False,
                                 help='Whether rotating the training images when training G_S')
        self.parser.add_argument('--Tanglejitter', action='store_true', default=False,
                      help='Whether rotating the training images when training G_T')
        # ouptput related
        self.parser.add_argument('--save_path', type=str, default='../save/',
                                 help='dir of the trained model to be saved')
        self.parser.add_argument('--save_name', type=str, default='fire',
                                 help='fikename of the trained model to be saved')
        # model related
        self.parser.add_argument('--GS_nlayers', type=int, default=6,
                                 help='number of layers in structure generator G_S')
        self.parser.add_argument('--DS_nlayers', type=int, default=4,
                                 help='number of layers in structure discriminator D_S')
        ...
        self.parser.add_argument('--DT_nlayers', type=int, default=4,
                                 help='number of layers in texture discriminator D_T')
        ...
        # trainingg related
        self.parser.add_argument('--scale_num', type=int, default=4,
                                 help='how many scales are uniformly sampled between [0,1]')
        self.parser.add_argument('--step1_epochs', type=int, default=30,
                                 help='epoch number of training G_S on the max scale {1}')
        self.parser.add_argument('--step2_epochs', type=int, default=40,
                                 help='epoch number of training G_S on the two extreme scales {0, 1}')
        self.parser.add_argument('--step3_epochs', type=int, default=80,
                                 help='epoch number of training G_S on the full scales')
        self.parser.add_argument('--step4_epochs', type=int, default=10,
                                 help='epoch number of training G_S with glyph loss')
        self.parser.add_argument('--texture_step1_epochs', type=int, default=40,
                                 help='epoch number of training G_T without style loss')
        self.parser.add_argument('--texture_step2_epochs', type=int, default=10,
                                 help='epoch number of training G_T with style loss')
        self.parser.add_argument('--batchsize', type=int, default=16, help='batch size')
        self.parser.add_argument('--subimg_size', type=int, default=256,
                                 help='size of sub-images, which are cropped from a single image to form a training set')
        self.parser.add_argument('--Straining_num', type=int, default=2560,
                                 help='how many training images in each epoch for strcture transfer')
        self.parser.add_argument('--Ttraining_num', type=int, default=800,
        ...
        self.parser.add_argument('--load_GB_name', type=str, default='../save/GBckpt',
                                 help='specified the dir of saved Sketch Module')
