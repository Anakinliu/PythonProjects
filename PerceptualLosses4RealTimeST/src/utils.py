...
def load_image(img_path, max_size=600, shape=None, is_path=True, target_size=None):
...
# def normalize_image_for_pre_vgg(image):
#     # print(f'normalize_image_for_pre_vgg{image.shape}')
#     # image_tmp = image.squeeze(dim=0)
#     # print(f'normalize_image_for_pre_vgg{image_tmp.shape}')
#
#     trans = transforms.Compose([
#         transforms.Normalize((0.485, 0.456, 0.406),
#                              (0.229, 0.224, 0.225))])
#     image = trans(image.squeeze(dim=0)).unsqueeze(0)
#     # print(f'normalize_image_for_pre_vgg{image.shape}')
#     return image
