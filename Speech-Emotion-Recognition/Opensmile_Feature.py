...
def get_feature_opensmile(filepath: str):
    ...
    cmd = 'cd ' + Config.OPENSMILE_PATH + ' && SMILExtract_Release -C X:/SoftOnSSD/opensmile-2.3.0/config/' + Config.CONFIG + '.conf -I ' + filepath + ' -O ' + BASE_DIR + '/' + Config.FEATURE_PATH + 'single_feature.csv'
    # cmd = '/SMILExtract_Release -C ../../config/' + Config.CONFIG + '.conf -I ' + filepath + ' -O ' + BASE_DIR + '/' + Config.FEATURE_PATH + 'single_feature.csv'
