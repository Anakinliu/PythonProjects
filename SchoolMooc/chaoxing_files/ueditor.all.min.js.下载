(function() {
            ...
            render:function(container) {
                ...
                if (container) {
                    ...
                    container.appendChild(domUtils.createElement(document, "iframe", {
                        ...
                        height:"100%",
                        frameborder:"0",
                        src:"javascript:void(function(){document.open();" + (options.customDomain && options.DIYDOMAIN != location.hostname ? 'document.domain="' + options.DIYDOMAIN + '";' :"") + 'document.write("' + html + '");document.close();}())'
                    }));
    ...
    (function() {
        ...
        var iframeUrlMap = {
            ...
            insertimage:"~/dialogs/image/image.html" + "#" + window.UEDITOR_CONFIG.DIYDOMAIN,
            link:"~/dialogs/link/link.html" + "#" + window.UEDITOR_CONFIG.DIYDOMAIN,
            ...
            attachment_new:"~/dialogs/attachment_new/attachment.html" + "#" + window.UEDITOR_CONFIG.DIYDOMAIN,
            symbol:"~/dialogs/symbol/symbol.html" + "#" + window.UEDITOR_CONFIG.DIYDOMAIN,
            mathml:"~/dialogs/mathml/mathml.html" + "#" + window.UEDITOR_CONFIG.DIYDOMAIN,
        ...
        var dialogBtns = {
            ...
            ok:[ "attachment", "anchor", "link", "insertimage", "map", "gmap", "insertframe", "wordimage", "insertvideo", "insertframe", "edittip", "edittable", "edittd", "scrawl", "template", "music", "background", "attachment_new", "symbol", "mathml" ]
        };
