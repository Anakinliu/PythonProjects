...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(200, 60, 381, 271))
        ...
        self.gridLayout.addWidget(self.pushButton_10, 2, 3, 2, 1)
        self.pushButton_9 = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.pushButton_9.setObjectName("pushButton_9")
        self.gridLayout.addWidget(self.pushButton_9, 0, 3, 2, 1)
