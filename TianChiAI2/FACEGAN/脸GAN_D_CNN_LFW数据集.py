...
channels = 3  # 输入图像的通道数？
img_size = 112  # 图像大小，正方形，和比赛给的大小一样
latent_dim = 100  # 潜在空间的维数
img_shape = (channels, img_size, img_size)  # 输入image的形状
outputs_path = f'FACE_GAN_D_CNN-WITH-LFW-01-batch{batch_size}'
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.cnn = nn.Sequential(
            ...
            *cnn_block(16, 16, 3, padding=1),
            *cnn_block(16, 32, 3, padding=1)
        )
        self.linear = nn.Sequential(
            *linear_block(6272, 1024),
